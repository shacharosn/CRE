...
with open("../span_bert/SpanBERT/permut_wiki_pure_exlusive_pred/data/json/test_13.json") as json_file:
...
with open("../span_bert/SpanBERT/permut_wiki_pure_exlusive__dir_pred/predictions_13.txt", "r") as f:
    contents = f.read()
...
for f_id in fixed_combine_sentences_per_id:
    ...
    preds = [samp['pred'] for samp in fixed_combine_sentences_per_id[f_id]]
    counts = Counter(preds)
    sorted_counts = counts.most_common()
