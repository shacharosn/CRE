...
with open("../span_bert/SpanBERT/permut_pred_tacred/data/json/test.json") as json_file:
...
with open("../span_bert/SpanBERT/permut_tacred_dir_pred/predictions.txt", "r") as f:
    contents = f.read()
